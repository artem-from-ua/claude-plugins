...
```markdown
5h 92% 50m !!   7d 22% ~5d   extra $4.79   $0.42   Sonnet 4.6   context 30%   my-project/   main*
```
...
**Tracked values:** 5h rate limit · 7d rate limit · extra usage ($ amount) · session cost · context % · directory · git branch · model name

**Progressive hiding:** On narrow terminals, less important segments (directory, session cost, extra usage) are automatically hidden to leave room for Claude Code system notifications.
