...
> **Visual styling:** Read `references/styling.md` for the arrow thickness table, the muted pastel palette, color support by diagram type, and legend guidance — including the three skinparams every legend needs (`legendBackgroundColor #EEEEEE`, `legendBorderColor transparent`, `LegendFontColor #404040`).
